...
export const buildCreatorNotesHtml = ({
    ...
    const creatorNotesStyle = `
        ...
        .creator-notes .panel-content { flex: 1 1 auto; padding: 16px 22px; }
        ...
        .creator-notes .cast-item:focus-within .cast-tooltip { opacity: 1; transform: translate(-50%, -2px); }
        ...
        .creator-notes .cast-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(128px, 1fr)); gap: 4px; margin-top: 4px; }
        ...
        @media (max-width: 700px) {
            ...
            .creator-notes .cast-grid { grid-template-columns: repeat(auto-fill, minmax(78px, 1fr)); gap: 6px; }
            .creator-notes .cast-portrait { width: 128px; height: 128px; }
        }
    `.replace(/\s+/g, ' ').trim();
