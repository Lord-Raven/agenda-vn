...
import { Actor, getActorVoiceVolume, getEmotionImage, getOutfitById } from "../content/Actor";
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <NovelVisualizer
                        ...
                        getActorVoiceModulation={(actor) => ({...actor.voiceModulation, volume: getActorVoiceVolume(actor.voiceId)})}
